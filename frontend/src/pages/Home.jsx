  ...
  return (
    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <h1 className='text-blue-500'>  LEARNIFY</h1>
        </span>
        <span className='lg:text-[70px] text-[20px] md:text-[40px] absolute lg:top-[18%] top-[20%] w-[100%] flex items-center justify-center text-white opacity-40 font-bold'>
